class SimulationConstants:
    ...
    def __init__(self, vehicle_width, vehicle_length, tunnel_length, track_width, track_height, track_start_point_distance, track_section_length_before, track_section_length_after):
