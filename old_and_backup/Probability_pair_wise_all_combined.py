...
if __name__ == '__main__':
    ...
    # dict_exp1 = {'40': [], '45': [], '50': [], '55': [], '60': []}
    # dict_exp1['40'].append(average_experiment1[0])
    # dict_exp1['45'].append(average_experiment1[1])
    # dict_exp1['50'].append(average_experiment1[2])
    # dict_exp1['55'].append(average_experiment1[3])
    # dict_exp1['60'].append(average_experiment1[4])
    ...
    # dict_exp2 = {'40': [], '45': [], '50': [], '55': [], '60': []}
    # dict_exp2['40'].append(average_experiment2[0])
    # dict_exp2['45'].append(average_experiment2[1])
    # dict_exp2['50'].append(average_experiment2[2])
    # dict_exp2['55'].append(average_experiment2[3])
    # dict_exp2['60'].append(average_experiment2[4])
    ...
    # average_list = pd.concat[average_experiment1, average_experiment2]
    # print(average_list)
