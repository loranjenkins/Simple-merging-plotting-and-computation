...
if __name__ == '__main__':
    ...
    # df_crts = pd.DataFrame(
    #     {'40': crts_experiment1_50_50,
    #      '50': crts_experiment1_55_45,
    #      '60': crts_experiment1_60_40
    #      })
    #
    # PROPS = {
    ...
    # }
    #
    # sns.boxplot(data=df_crts, **PROPS)
    #
    # plt.title('Comparison CRT all conditions')
    # plt.ylabel('CRT [s]')
    # plt.xlabel('Velocity vehicle 1')
    #
    # figure_amount = 0
    # fig = plt.savefig(r'D:\Thesis_data_all_experiments\Conditions\figures_all_conditions\boxplot_per_experiment\boxplot_experiment1_{}'.format(str(figure_amount)))
    # plt.close(fig)
    # figure_amount += 1
