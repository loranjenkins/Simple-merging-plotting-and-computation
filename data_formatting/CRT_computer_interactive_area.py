...
if __name__ == '__main__':
    ...
    df4 = pd.DataFrame({'crt_index_50_50': crt_indexes_50_50})
    df5 = pd.DataFrame({'crt_index_55_45': crt_indexes_55_45})
    df6 = pd.DataFrame({'crt_index_60_40': crt_indexes_60_40})
