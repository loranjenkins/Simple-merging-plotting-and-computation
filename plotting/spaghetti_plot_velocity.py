...
def get_dict(path_to_data_csv, who_is_ahead):
    ...
    print(indexes_of_tunnel_vehicle1)
    print(indexes_of_tunnel_vehicle2)
    ...
    if who_is_ahead == 'vehicle1':
        for pandas in range(len(all_pds_list)):
            ...
            a = time_in_seconds_trail_[indexes_of_tunnel_vehicle1[pandas]]

            index_of_other_vehicle_leaving = min(range(len(time_in_seconds_trail_)), key=lambda i: abs(
                time_in_seconds_trail_[i] - (4.67+time_in_seconds_trail_[indexes_of_tunnel_vehicle1[pandas]])))

            time_in_seconds_trail = time_in_seconds_trail_[indexes_of_tunnel_vehicle1[pandas]:index_of_other_vehicle_leaving]
...
if __name__ == '__main__':
    path_to_csv_vehicle1_ahead = r'D:\Thesis_data_all_experiments\Conditions\Conditions_who_is_ahead\whos_ahead_60_40 - kopie\vehicle1'
    who_is_ahead = 'vehicle1'
    dict55_45_v1_ahead = get_dict(path_to_csv_vehicle1_ahead, who_is_ahead)
