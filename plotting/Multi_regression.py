...
if __name__ == '__main__':
    ...
    lm_all = pg.linear_regression(df[['CRT', 'relative_velocity']], df['% fixation on opponent'])

    # lm_condition2_3 = pg.linear_regression(df2_3[['CRT', 'relative_velocity', 'ahead_behind', 'speed']], df2_3['% fixation on opponent'])

    lm_condition2_3 = pg.linear_regression(df2_3[['CRT', 'relative_velocity', 'ahead_behind']], df2_3['% fixation on opponent'])
