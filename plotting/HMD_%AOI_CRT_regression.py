...
if __name__ == '__main__':
    ...
    fixations_50_50 = pd.concat([df_50_50['% fixation vehicle 1'], df_50_50['% fixation vehicle 2']], axis=0, ignore_index=True).rename(
        '% fixation on opponent')
    crts_50_50 = pd.concat([df_50_50['CRT'], df_50_50['CRT']], axis=0, ignore_index=True)
    df_50_50 = pd.concat([crts_50_50, fixations_50_50], axis=1)
