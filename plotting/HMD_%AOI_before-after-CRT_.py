...
if __name__ == '__main__':
    ...
    #
    # ax5.set(xlabel='Time relative to CRT [s]', ylabel='Fixation on opponent [%]')
    ...
    fig.text(0.5, 0.04, "Time relative to CRT [s]", ha="center", va="center")
